...
describe('useUiTheme', () => {
  ...
  it('returns the surrounding toolkit theme', () => {
    const resolved: Theme = themeFromHook(createUiTheme({ variant: 'crm' }));

    expect(resolved).not.toBe(uiTheme);
    expect(resolved.breakpoints.values).toEqual(crmBreakpointValues);
  });
