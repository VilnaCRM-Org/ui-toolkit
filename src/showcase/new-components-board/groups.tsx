...
// Every new Epic-2, Epic-3 and Story-3.7 control (the ones CRM/website lack) laid
// out at its exact Figma component width, in every state Figma draws, in the board's
// own y-order. Prop-driven states render directly; interaction states Figma draws as
