...
// Every new Epic-2/Epic-3 control (the ones CRM/website lack) laid out at its exact
// Figma component width, in every state Figma draws, in the board's own y-order.
// Prop-driven states render directly; interaction states Figma draws as separate
// frames (hover, press, open dropdown) are forced on statically. Everything is
// fluid below 480px (mobile).
