...
// render directly; interaction states Figma draws as separate frames (hover, open
// dropdown, open menu) are forced on statically. Everything is fluid below 480px
// (mobile).
