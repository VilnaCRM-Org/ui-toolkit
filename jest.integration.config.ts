...
const config: Config = {
  ...
  collectCoverageFrom: [
    '<rootDir>/src/components/auth-skeleton/**/*.{ts,tsx}',
    '<rootDir>/src/components/layout/**/*.{ts,tsx}',
    '<rootDir>/src/components/ui-form/**/*.{ts,tsx}',
    '<rootDir>/src/components/ui-text-field-form/**/*.{ts,tsx}',
    '<rootDir>/src/components/ui-footer/**/*.{ts,tsx}',
    '<rootDir>/src/components/ui-card-list/**/*.{ts,tsx}',
    ...
    '!<rootDir>/src/components/ui-card-list/card-swiper.tsx',
    '!<rootDir>/src/components/ui-card-list/card-grid.tsx',
  ],
