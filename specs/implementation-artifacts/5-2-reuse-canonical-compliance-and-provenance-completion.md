...
| Story 5.3 (`5-3-export-contract-and-entry-point-integrity.md`)           | `Evidence-elsewhere` — `art §Changed files` is still `_(completed at hand-off)_`; satisfied by the issue #33 PR diff                                                                               | `Evidence-elsewhere` — `art §Definition of Done` §2: the story adds no module, so `component-provenance.md` gains no row; its one provenance-surface edit is the `DEV-42` correction in the ledger, made under Story 5.2's own hand-off | `Complete` — `art §Definition of Done` §3; `tests/unit/export-contract-integrity.test.ts` added as the export drift guard                                                                                                                                                                                  | `Complete` — not applicable: no rendered output changes, so no story and no baseline change; `tests/visual/stories.json` is read, not modified                                                                                                                                              | `Complete` — `art §Definition of Done` §5: public type exports added across the delivered set; `src/components/index.ts` gains type-only exports and no value export is added, removed or renamed; the surface is locked by `specs/planning-artifacts/export-contract.md` and `tests/unit/export-contract-integrity.test.ts` | `Complete` — not applicable: no design or source-parity mandate and no visual surface change                                                                                                                                                        | `Evidence-elsewhere` | Open — PR #127, draft, base `feat/issue-32-provenance-compliance`; issue #33 OPEN                                                                                                   |
| Story 1.4 (`1-4-epic-1-quality-gate-closure.md`)                         | `Complete` — `art §Changed files`, four rows                                                                                                                                                       | `Complete` — `art §Definition of Done` §2: closure adds no module, so the registry gains no row                                                                                                                                         | `Complete` — `art §Gate evidence`; `tests/unit/epic-quality-gate-closure.test.ts` added as the closure guard                                                                                                                                                                                               | `Complete` — not applicable: closure reviews and pins existing coverage; the manifest is read by the guard, not modified                                                                                                                                                                    | `Complete` — `art §AC-3`: no export change; the Epic 1 surface is pinned by the closure guard                                                                                                                                                                                                                                | `Complete` — not applicable: no design or source-parity mandate; board-parity state evidence cited from `chk`                                                                                                                                       | `Complete`           | Merged — PR #132 → `feat/issue-33-export-contract`, 2026-08-24, carried to `main` by PR #127, 2026-09-07; issue #27 CLOSED 2026-09-10                                               |
| Story 2.6 (`2-6-epic-2-quality-gate-closure.md`)                         | `Complete` — `art §Changed files` (shared closure-branch changes owned by the Story 1.4 artifact)                                                                                                  | `Complete` — `art §Definition of Done` §2: closure adds no module; per-component provenance lives in `reg §Epic 2`                                                                                                                      | `Complete` — `art §AC-1` suite table and `art §Gate evidence`; enforcement by the shared closure guard                                                                                                                                                                                                     | `Complete` — not applicable: closure reviews and pins existing coverage; no story or baseline change                                                                                                                                                                                        | `Complete` — `art §AC-2`: no export change; the Epic 2 surface is pinned by the closure guard                                                                                                                                                                                                                                | `Complete` — not applicable: no design or source-parity mandate; parity evidence cited from the delivery artifacts and `chk`                                                                                                                        | `Complete`           | Merged — PR #132 → `feat/issue-33-export-contract`, 2026-08-24, carried to `main` by PR #127, 2026-09-07; issue #28 CLOSED 2026-09-10                                               |
| Story 3.6 (`3-6-epic-3-quality-gate-closure.md`)                         | `Complete` — `art §Changed files` (shared closure-branch changes owned by the Story 1.4 artifact)                                                                                                  | `Complete` — `art §Definition of Done` §2: closure adds no module; per-component provenance lives in `reg §Epic 3`                                                                                                                      | `Complete` — `art §Scope` suite table and `art §Gate evidence`; enforcement by the shared closure guard                                                                                                                                                                                                    | `Complete` — not applicable: closure reviews and pins existing coverage; no story or baseline change                                                                                                                                                                                        | `Complete` — `art §AC-2`: no export change; the Epic 3 surface is pinned by the closure guard                                                                                                                                                                                                                                | `Complete` — not applicable: no design or source-parity mandate; parity evidence cited from the delivery artifacts and `chk`                                                                                                                        | `Complete`           | Merged — PR #132 → `feat/issue-33-export-contract`, 2026-08-24, carried to `main` by PR #127, 2026-09-07; issue #29 CLOSED 2026-09-10                                               |
| Story 3.7 (`3-7-board-follow-up-controls.md`)                            | `Complete` — `art §1 Changed files` inventories all 158 changed paths, generated from `git diff --name-only main...HEAD` and grouped by module, showcase, tests, manifest, baselines and registers | `Complete` — `reg` "Story 3.7 — Board Follow-Up Controls" (eight new rows, source `new`) and the extended Epic 1 `UiButton` row; `led DEV-51`-`DEV-64` record every deviation                                                           | `Complete` — eight `tests/unit/ui-<kebab>.test.tsx` suites (`ui-background-picker`, `ui-option-card`, `ui-chevron-button`, `ui-add-button`, `ui-clear-button`, `ui-copy-field`, `ui-social-icon-button`, `ui-segmented-control`) plus the danger-variant block appended to `tests/unit/ui-button.test.tsx` | `Complete` — eight `*.stories.tsx` files plus a `Danger` story in `button.stories.tsx` (title `'UiComponents/Ui<Name>'`, `tags: ['autodocs']`); `tests/visual/stories.json` regenerated from the live index, 123 → 141 entries (18 new story ids). Pixel baselines for all 18 are committed | `Complete` — `src/components/index.ts` carries eight new default+type export pairs (`UiButton` gains no export, only a prop value); `chk` Board A/B rows above cite the barrel                                                                                                                                               | `Complete` — `art §Design sources — Figma node map` carries per-state node ids for all nine components (background-picker, button-danger, option-card, chevron-button, add-button, clear-button, copy-field, social-icon-button, segmented-control) | `Complete`           | Merged — PR [#150](https://github.com/VilnaCRM-Org/ui-toolkit/pull/150) → `main`, 2026-09-08; issue [#149](https://github.com/VilnaCRM-Org/ui-toolkit/issues/149) CLOSED 2026-09-08 |
| Story 4.4 (`4-4-skeleton-parity-and-quality-gate-closure.md`)            | `Complete` — `art §Changed files`, four rows                                                                                                                                                       | `Complete` — `art §Definition of Done` §2: closure adds no module; per-component provenance lives in `reg §Epic 4`                                                                                                                      | `Complete` — `art §Scope` suite table; enforcement by the shared closure guard's `Epic 4` entry                                                                                                                                                                                                            | `Complete` — not applicable: closure reviews and pins existing coverage; no story or baseline change                                                                                                                                                                                        | `Complete` — `art §AC-3`: no export change; the twelve skeleton exports checked against `export-contract.md`                                                                                                                                                                                                                 | `Complete` — `art §AC-1`: CRM animation parity held by `tests/unit/skeleton-crm-parity.test.ts`; skeleton deviations `led DEV-10`/`DEV-11`/`DEV-14`/`DEV-17`/`DEV-18`                                                                               | `Complete`           | Issue #30 CLOSED 2026-09-10 without its artifact; the artifact lands with the issue #34 PR                                                                                          |

Roll-up: 9 rows `Complete`, 15 rows `Evidence-elsewhere`, 1 row `Gap`. The single `Gap` is the
parity layer's §6, ruled on immediately below. Story 3.7's row closed at `Complete` once its own
`art §1 Changed files` inventory and the regenerated `tests/visual/stories.json` landed; the one
item still outstanding for that story is its pixel baselines, which its own DoD table records as
an open follow-up rather than a matrix gap. The three `Complete` closure rows (Stories 1.4, 2.6, 3.6) were appended by the Epic
1-3 quality-gate closure story, as group H of `tests/unit/component-provenance-traceability.test.ts`
requires for every new implementation artifact — Story 3.7's own row was appended for the same
reason. Story 4.4's row was appended with its closure artifact under issue #34.
...
5.4 must not re-derive delivery status from it. Measured on 2026-08-06, refreshed on 2026-09-24:

- Issues #16 and #18 stayed OPEN after their delivery PRs #112 and #116 **merged**, because both
  merged into a feature base (`feat/issue-15-calendar-multi-select` and
  `feat/issue-17-file-upload-input`) rather than into `main`, so their `Closes #NN` keywords never
  fired. Both were closed by hand on 2026-09-10.
- Issues #17, #19, #20, #21, #22, #23, #24, #25 and #26 were OPEN on 2026-08-06 because their
  delivery PRs (#114, #117, #120, #121, #122, #123, #124) were still open in the review stack. All
  of them are now CLOSED (between 2026-08-28 and 2026-09-10), and PR #124 merged into `main` on
  2026-09-02.
...
| `DEV-66`            | `UiBackToMain` label ink `#969B9D` at 2.81:1 on white deferred                                | `unfiled:accessibility-lead` | File with `DEV-03`: the same contrast class, added by #138 when the link was restored from kit tokens (it had rendered near-white on white). Behavioural a11y is delivered; only the sighted-user ink is outstanding.                                                                                                                                                                                                                                                                                       |
