...
- **PR:** [#120](https://github.com/VilnaCRM-Org/ui-toolkit/pull/120)
...
| Rest/active/disabled interaction semantics clear       | AC1 | ✅ Figma rest+hover (the only masters); `aria-disabled` boundary        |
